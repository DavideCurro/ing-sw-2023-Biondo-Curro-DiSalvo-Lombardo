...
public class goal11TestNotAchieved {
    ...
    public void validateGoal11b(){
        assertFalse(objectiveCommonEXEC.execCheck(new Player(library1)));
    }
    @Test
    public void validateGoal11c(){
        assertFalse(objectiveCommonEXEC.execCheck(new Player(library2)));
    }
    @Test
    public void validateGoal11d(){
        assertFalse(objectiveCommonEXEC.execCheck(new Player(library3)));
    }
