 ...
 * Green 4
 * Pink 5 */
public class GoalP6 implements PersonalObj, Serializable {
    ...
    public GoalP6(){
        ...
        int[] x = new int[] {0,0,2,4,4,5}; //rows
        int[] y = new int[] {2,4,3,1,3,0}; //columns
        int[] type = new int[] {CYAN,GREEN,WHITE,YELLOW,BLUE,PINK};
